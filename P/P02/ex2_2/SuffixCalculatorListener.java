...
public interface SuffixCalculatorListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code ExprNormal}
	 * labeled alternative in {@link SuffixCalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterExprNormal(SuffixCalculatorParser.ExprNormalContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprNormal}
	 * labeled alternative in {@link SuffixCalculatorParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitExprNormal(SuffixCalculatorParser.ExprNormalContext ctx);
}